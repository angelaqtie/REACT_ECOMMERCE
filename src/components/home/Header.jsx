  ...
  return (
    <header className=" fixed z-50 bg-white w-full top-0 left-0">
      ...
      <div className="container">
        <div className="toggle flex justify-between  py-5">
        ...
        <nav
          className={`fixed md:gap-10 md:grid md:grid-cols-3  md:w-[2570px] mx-auto items-center pb-5 md:static w-full  h-screen md:h-auto top-[9rem]left-0 bg-white md:bg-transparent ${
            isOpen ? "text-black block" : "hidden md:block"
          }`}
        >
          <ul className="md:flex md:flex-row flex flex-col gap-10 translate-x-[50px] md:translate-x-0 translate-y-[50px] md:translate-y-0 w-[75%] md:w-full">
            <li>
              <NavLink>Men</NavLink>
            </li>
            <li>
